    ...
    <nav className="fixed w-full top-0 z-50 glass">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl md:text-2xl font-bold tracking-wide text-brand-gold">
            علي بابا للشوكولاتة
          </h1>
        </div>
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium text-brand-cream/80">
          ...
          <a href="/#custom-box" className="hover:text-brand-gold transition duration-300">صمم بوكس</a>
          <a href="/#products" className="hover:text-brand-gold transition duration-300">المنتجات</a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#140d0b] border-b border-brand-gold/20 py-4 px-6 flex flex-col gap-4 shadow-2xl animate-fade-in-up">
          ...
          <a href="/#custom-box" onClick={() => setIsOpen(false)} className="text-brand-cream hover:text-brand-gold py-2 border-b border-white/5">صمم بوكس</a>
          <a href="/#products" onClick={() => setIsOpen(false)} className="text-brand-cream hover:text-brand-gold py-2 border-b border-white/5">المنتجات</a>
